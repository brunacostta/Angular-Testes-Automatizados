...
describe(UniqueIdService.name, () => {
  ...
  it(`#${UniqueIdService.prototype.getNumberOffGenerateUniqueId.name} should return the number of generatedIds when called`, () => {
    service.generateUniqueIdWithPrefix('app');
    service.generateUniqueIdWithPrefix('app');
    expect(service.getNumberOffGenerateUniqueId()).toBe(2);
  });
